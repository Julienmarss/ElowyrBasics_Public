...
public class BlackMarketRemoveQuantityCommand {

    @Command(name = "blackmarket.remove.quantity", aliases = "bm.remove.quantity", permission = "elowyrbasics.blackmarket.quantity.remove")
    public void onCommand(CommandArgs args) {
        ...
        if (args.length() != 2) {
            player.sendMessage(Utils.color("&c/blackmarket remove quantity <id> <quantity>."));
            return;
        }
